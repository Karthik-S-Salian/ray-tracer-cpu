...
int main(){
    ...
    //calculate the locatio of upper left pixel

    auto viewport_upper_left = camera_center - vec3(camera_center.x(),camera_center.y(),focal_length) - 0.5*(viewport_u+viewport_v);
